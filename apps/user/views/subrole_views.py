...
from apps.formulario.models.formulario import Formulario, ValidateFormulario, VerifyFormulario
from apps.traceability.models.traceability import Traceability, ValidateTraceability, VerifyTraceability
from apps.formulario.models.question import Question
from apps.supplybase.models.supplybase import SupplyBaseRegister
...
class SubroleCreateView(SuccessMessageMixin, CreateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        models = [
                Company, ValidateCompany, VerifyCompany,
                User, CompanyGroup, Commodity,
                Traceability, ValidateTraceability, VerifyTraceability,
                Formulario, ValidateFormulario, VerifyFormulario,
                QuestionBank, ProforestForm, ActorType, Category, SubCategory, Topic,
                SupplyBaseRegister,
                MenuPermissions,
                Question]
        for model in models:
