...
from ..serializers.formulario_serializer import ( FormularioSerializer, FormularioAsignSerializer, 
                                                ...
                                                FormularioSerializerList, FormularioUpdateSerializer)
...
class VerificateListFormularios(generics.ListAPIView):
...
class AssignVerificateListFormularios(APIView):
...
@permission_classes([IsAuthenticated])
class FormularioAssignVerificators(generics.UpdateAPIView):
    queryset = Formulario.objects.all()
